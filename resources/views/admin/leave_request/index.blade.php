                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <a  href="{{route('admin.leave-requests.accept',$request->id)}}" class="btn btn-sm btn-outline-success">قبول</a>
                          <a  href="{{route('admin.leave-requests.reject',$request->id)}}" class="btn btn-sm btn-outline-danger">رفض</a>
                          @else
                          _  
                          @endif
                        </td>
